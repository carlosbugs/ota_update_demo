/* We include the necessary header files and extern-define 2 global variables marking the start and end address of the server certificate which is embedded in the firmware binary. 
The certificate is needed for secure connection to the HTTPS server.  exit_ota is a simple helper function to be used before exiting the OTA process.
*/
